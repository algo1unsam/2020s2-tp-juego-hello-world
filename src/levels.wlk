...
object level1 {
	...
	method renderNewBlocks() {
		...
		game.onTick(30000, "generacion New Terreno", {=> 1.randomUpTo(3).roundUp().times({ i =>
	...
	method renderEnemies() {
		const posicionesIniciales = [ game.at(0,10), game.at(12,10), game.at(6,10), game.at(0,0), game.at(10,0), game.at(10,6), game.at(6,6), game.at(6,0), game.at(0,6) ]
		var tanqueEnemigos
